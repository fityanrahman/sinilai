    ...
    <body>
        <header>
            <nav>
                ...
                <a href="<?php echo base_url()?>" class="brand-logo left titleheader ">Attaqwa</a>
                    ...
                    <a href="<?php echo base_url('profile'); ?>"><span class="white-text name"><?php echo ucwords(strtolower($this->session->userdata('nama'))); ?></span></a>
